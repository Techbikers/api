...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RiderProfile.donation_page'
        db.add_column('riders_profiles', 'donation_page',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RiderProfile.donation_page'
        db.delete_column('riders_profiles', 'donation_page')
    ...
    models = {
        ...
        'riders.riderprofile': {
            ...
            'donation_page': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
