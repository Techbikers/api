...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chapter.stripe_priv_key'
        db.add_column('chapters', 'stripe_priv_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Chapter.stripe_pub_key'
        db.add_column('chapters', 'stripe_pub_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chapter.stripe_priv_key'
        db.delete_column('chapters', 'stripe_priv_key')

        # Deleting field 'Chapter.stripe_pub_key'
        db.delete_column('chapters', 'stripe_pub_key')
