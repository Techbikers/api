...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ride.price'
        db.alter_column('rides', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Ride.price'
        db.alter_column('rides', 'price', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'rides.rideriders': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 9, 0, 0)'}),
        ...
        'sales.sale': {
            ...
            'sale_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 9, 0, 0)'})
        }
    }
