...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Ride'
        db.create_table('rides', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='255')),
            ('slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length='255')),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('start_location', self.gf('django.db.models.fields.CharField')(max_length='255')),
            ('end_location', self.gf('django.db.models.fields.CharField')(max_length='255')),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('rider_capacity', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal('rides', ['Ride'])

        # Adding M2M table for field riders on 'Ride'
        m2m_table_name = db.shorten_name('rides_riders')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ride', models.ForeignKey(orm['rides.ride'], null=False)),
