...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ride.preregistration_required'
        db.add_column('rides', 'preregistration_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ride.preregistration_required'
        db.delete_column('rides', 'preregistration_required')
    ...
    models = {
        ...
        'rides.ride': {
            ...
            'preregistration_required': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'rides.rideriders': {
            ...
            'signup_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 29, 0, 0)'}),
        ...
        'sales.sale': {
            ...
            'sale_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 29, 0, 0)'})
        }
    }
