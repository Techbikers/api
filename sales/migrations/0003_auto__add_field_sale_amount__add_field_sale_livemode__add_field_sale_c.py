...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.amount'
        db.add_column('sales', 'amount',
                      self.gf('django.db.models.fields.IntegerField')(max_length=6, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sale.livemode'
        db.add_column('sales', 'livemode',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Sale.card'
        db.add_column('sales', 'card',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sale.amount'
        db.delete_column('sales', 'amount')

        # Deleting field 'Sale.livemode'
        db.delete_column('sales', 'livemode')

        # Deleting field 'Sale.card'
        db.delete_column('sales', 'card')
    ...
    models = {
        ...
        'sales.sale': {
            ...
            'sale_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 11, 0, 0)'})
        }
    }
