...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sale.currency'
        db.add_column('sales', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='gbp', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sale.currency'
        db.delete_column('sales', 'currency')
