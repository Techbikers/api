...
import server.core.models.sponsors
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(upload_to=server.core.models.sponsors.generate_filename)),
                ('website', models.URLField(blank=True)),
                ('twitter', models.URLField(blank=True)),
                ('facebook', models.URLField(blank=True)),
                ('riders', models.ManyToManyField(to=settings.AUTH_USER_MODEL, blank=True)),
                ('rides', models.ManyToManyField(to='core.Ride', through='core.RideSponsor', blank=True)),
            ],
            options={
                'db_table': 'sponsors',
            },
