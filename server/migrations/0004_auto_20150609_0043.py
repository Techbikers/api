...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('server', '0003_auto_20150529_1744'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='chapter',
            field=models.ForeignKey(to='server.Chapter'),
        ),
        migrations.AddField(
            model_name='membership',
            name='sale',
            field=models.ForeignKey(blank=True, to='server.Sale', null=True),
        ),
        migrations.AddField(
            model_name='membership',
            name='user',
        ...
        migrations.AddField(
            model_name='chapter',
            name='members',
            field=models.ManyToManyField(to=settings.AUTH_USER_MODEL, through='server.Membership', blank=True),
        ),
    ]
